...
#include "Resources_UNO_template\UNO_TWI_subroutines_V6.c"
#include "Resources_UNO_template\ASKII_subroutines_V6.c"
#include "Resources_UNO_template\PCI_subroutines_V6.c"
