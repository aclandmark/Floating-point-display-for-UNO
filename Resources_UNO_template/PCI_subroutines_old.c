...
switch (data_zero){
case ('9' | 0x80): data_buff[0] = ('0' | 0x80);break;

case '-':
case 'e': 
case ('-' | 0x80):
case ('e' | 0x80): data_buff[0] = ('0' | 0x80);break;


default:  data_buff[0] += 1;
...
case 0b11110: data_buff[0] = '-'; break;				//Waiting for first character: digits[0] = '\0'
case 0b01010: data_buff[0] = '.'; break;				//Waiting for second character: negative number digits[0] = '-'
case 0b01000: data_buff[0] = '0'; break;				//LHS waiting for first digit (0 to 9)
case 0b01011: data_buff[0] = '.'; break;				//digits[0] = 0 to 9: can receive d.p. e or additional digit
case 0b01001: data_buff[0] = 'e'; break;				//Real number: can only receive e or additional digits
case 0b00000: data_buff[0] = '0'; break;				//RHS: Can only receive digits
case 0b00100: data_buff[0] = '-'; break;} break;		//RHS: can receive a - or a digit
		

case '-':
switch(scroll_control){
case 0b11110: data_buff[0] = '.'; break;				//Waiting for first character: digits[0] = '\0'
case 0b00100: data_buff[0] = '0'; break;} break;		//RHS: can receive a - or a digit

case '.':
switch(scroll_control){
case 0b11110: data_buff[0] = '0'; break;				//Waiting for first character: digits[0] = '\0'
case 0b01010: data_buff[0] = '0'; break;				//Waiting for second character: negative number digits[0] = '-'
case 0b01011: data_buff[0] = 'e'; break;} break;		//digits[0] = 0 to 9: can receive d.p. e or additional digit
	

case 'e':
switch(scroll_control){
case 0b01011: data_buff[0] = '0'; break;				//digits[0] = 0 to 9: can receive d.p. e or additional digit
case 0b01001: data_buff[0] = '0'; break;} break;		//Real number: can only receive e or additional digits
