...
#include "Resources_UNO_template\UNO_TWI_subroutines_V5.c"
#include "Resources_UNO_template\ASKII_subroutines_V5.c"
#include "Resources_UNO_template\PCI_subroutines_V5.c"
...
wdt_enable(WDTO_1S);\
while(1){if((Serial.read()== 'a') || (switch_2_down))\
...
if (switch_1_down)float_num_1 = pow(float_num_1, 1.25);\
