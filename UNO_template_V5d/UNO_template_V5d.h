...
#include "Resources_UNO_template\UNO_TWI_subroutines_V5d.c"
#include "Resources_UNO_template\ASKII_subroutines_V5d.c"
#include "Resources_UNO_template\PCI_subroutines_V5d.c"
...
/*
#define FPN_arithmrtic_1 \
{do{while((switch_1_up)&&(switch_2_up));\
if (switch_1_down)float_num = pow(float_num, 1.1);\
else float_num = pow(float_num, 0.9);\
_delay_ms(100);\
float_num_to_display(float_num);\
}while(float_num);}\
while((switch_1_down) || (switch_2_down));

#define FPN_arithmrtic_2 \
{while(1){\
while((switch_1_up)&&(switch_2_up));\
if (switch_1_down)float_num -= 1.0;\
else float_num += 1.0;\
_delay_ms(100);\
float_num_to_display(float_num);\
while((switch_1_down) || (switch_2_down));\
...
#define FPN_arithmrtic_2a \
{while(1){\
while((switch_1_up)&&(switch_2_up));\
if (switch_1_down)float_num -= 1.1;\
else float_num += 1.1;\
_delay_ms(100);\
float_num_to_display(float_num);\
while((switch_1_down) || (switch_2_down));\
...
/*
#define FPN_arithmrtic_3 \
{while(1){while((switch_1_up)&&(switch_2_up));\
while (switch_1_down){float_num = pow(float_num, 1.1);\
_delay_ms(100);\
float_num_to_display(float_num);}\
while((switch_1_down) || (switch_2_down));\
if (switch_3_down){SW_reset;}}}

#define FPN_arithmrtic_4 \
{while(1){while((switch_1_up)&&(switch_2_up));\
while (switch_1_down){float_num /= 2.2;\
_delay_ms(100);\
float_num_to_display(float_num);}\
while((switch_1_down) || (switch_2_down));\
if (switch_3_down){SW_reset;}}}
...
{while(1){while((switch_1_up)&&(switch_2_up));\
if (switch_1_down)float_num -= 2.0;\
else float_num += 2.0;\
if(float_num_to_display(float_num)); else {float_num = 0.0;}\
while((switch_1_down) || (switch_2_down));\
if (switch_3_down){SW_reset;}}}*/
